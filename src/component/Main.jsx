...
export default function Main() {
  let storyBoardContent =
    'You wake up in the woods and have no idea how you got there.  There is a path due North in front of you.  What direction would you like to go?';
  ...
  function handleClick() {
    if (state === storyBoardContent) {
      setState(
        "You clicked the INPUT BOX!!! Now type 'help', 'inventory' or 'north'"
      );
      setInstruction('=)');
    } else {
  ...
  function handleInputChange(e) {
    ...
    if (fourthWall && targetValue === 'north') {
      ...
      setSelfAware(
        "oh...the bear is gone...uhhh...maybe just don't do anything...I haven't planned this far ahead yet"
      );
      ...
      setInstruction('');
      setSelfAware(
        'Hey there...Welcome back to the land of the living...what will you do differently this time I wonder...'
      );
      setForthWall(true);
      setInventory(['an old lighter']);
    } else if (targetValue === 'use old lighter') {
      setState(
        'You attempt to spark the lighter but it crumbles apart in your hand...almost as if it never even existed...'
      );
      setInputValue('');
